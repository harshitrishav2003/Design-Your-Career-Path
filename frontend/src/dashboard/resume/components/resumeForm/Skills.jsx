...
function Skills() {
  ...
  return (
    ...
    <div className='grid-cols-2 grid mt-2 '>
        {skillsList.map((item,index)=>(
            <div className=' mb-2 rounded-lg mr-2' key={index}>
                <div className=''>
                    <label className='block  font-medium'>Skills Name</label>
                    <Input className="w-full"
                    defaultValue={item.name}
                    placeholder="e.g. Php, Java, React.Js"
